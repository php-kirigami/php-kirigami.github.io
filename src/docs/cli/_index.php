 ...
 *             build, export, watch, serve, run, create, install, cache,
 *             phpinfo.
 * @breadcrumb true
 */
?>
...
<section class="section wrap">
    <ul class="docs-toc">
        ...
        <li><a href="#kiri-build">kiri build</a></li>
        <li><a href="#kiri-export">kiri export</a></li>
        <li><a href="#kiri-watch">kiri watch</a></li>
        <li><a href="#kiri-serve">kiri serve</a></li>
        <li><a href="#kiri-run">kiri run</a></li>
        <li><a href="#kiri-create">kiri create</a></li>
        <li><a href="#kiri-install">kiri install</a></li>
        <li><a href="#kiri-cache">kiri cache</a></li>
        <li><a href="#kiri-phpinfo">kiri phpinfo</a></li>
    ...
    <div class="prose">
        <markdown>
          ...
          `kiri` is provided by the `@kirigami/kirigami` dev dependency — run
          it as `npx kiri <command>`, or add scripts to `package.json` (every
          official template does: `npm run dev`, `npm run build`, …). Every
          command accepts `--help`, and so does bare `kiri`:
          ...
          Type `kiri <command> --help` for detailed help on a command.
          ```
